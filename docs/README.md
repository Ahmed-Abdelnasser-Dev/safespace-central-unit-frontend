...
| [design.md](./design.md) | Design system: colors, tokens, UI primitives, conventions |
...
| [dashboard.md](./features/dashboard.md) | Completed (KPIs are mock data, see bugs.md) |
| [incidents.md](./features/incidents.md) | Completed |
| [map.md](./features/map.md) | Completed |
