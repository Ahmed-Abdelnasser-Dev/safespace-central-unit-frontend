    ...
    <Modal open={open} onClose={onClose} size="md">
      ...
      <Modal.Content>
        <p className="text-safe-text-gray text-sm mb-4">
          Dispatching{' '}
          <span className="text-safe-text-primary font-semibold">
        ...
        <ul className="space-y-2 mb-5">
          {selectedUnits.map((unit) => (
            ...
            >
              ...
              />
              <span className="flex-1 text-sm font-medium text-safe-text-primary truncate">
                {unit.name}
              </span>
        ...
        <p className="text-xs text-safe-text-gray bg-safe-gray rounded-lg px-3 py-2.5 border border-safe-border/20">
          Each dispatched unit will move to <strong className="text-safe-text-primary">en route</strong>{' '}
