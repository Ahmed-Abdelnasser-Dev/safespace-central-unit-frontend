      ...
      {type === 'number' ? (
        <div className="flex items-center gap-[12px]">
          <input
            ...
            className="flex-1 h-2 bg-safe-gray-light rounded-lg appearance-none cursor-pointer accent-[#247cff]"
          />
        ...
        <input
          ...
          className="w-full px-[12px] py-[10px] border border-safe-gray-light rounded-[6px] text-safe-text-primary bg-safe-gray focus:outline-none focus:ring-2 focus:ring-[#247cff] focus:ring-opacity-20 transition-all duration-200"
