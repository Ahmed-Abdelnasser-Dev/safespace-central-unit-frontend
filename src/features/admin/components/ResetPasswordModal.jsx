      ...
      <div className="bg-safe-sidebar rounded-xl shadow-2xl w-full max-w-lg mx-4 animate-slideUp">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 text-[12px] font-medium rounded-md border transition-colors ${
                      copied
                        ...
                        : 'bg-safe-sidebar border-safe-border text-safe-text-dark hover:bg-safe-bg'
                    }`}
                  >
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-3.5 border rounded-lg transition-all ${
                    mode === 'email'
                      ...
                      : 'border-safe-border hover:border-safe-blue-btn/40 bg-safe-sidebar'
                  }`}
                >
        ...
        <div className="px-7 py-4 border-t border-safe-border flex items-center justify-end gap-2.5">
          <button
            type="button"
            onClick={handleClose}
            className="px-4 py-2 text-[13px] font-medium text-safe-text-dark bg-safe-sidebar border border-safe-border hover:bg-safe-bg rounded-lg transition-colors"
          >
