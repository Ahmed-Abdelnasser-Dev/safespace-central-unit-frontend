          ...
          {step === 'offer' ? (
            <>
              ...
              <button
                ...
                disabled={loading}
                className="px-4 py-2 text-[13px] font-medium text-safe-danger bg-white border border-safe-danger/30 hover:bg-safe-danger/5 rounded-lg transition-colors disabled:opacity-50"
              >
                Delete instead →
              </button>
            </>
            ...
            <>
              <button
                ...
                disabled={loading}
                className="px-4 py-2 text-[13px] font-medium text-safe-text-dark bg-white border border-safe-border hover:bg-safe-bg rounded-lg transition-colors disabled:opacity-50"
              >
                Cancel
              </button>
              <button
