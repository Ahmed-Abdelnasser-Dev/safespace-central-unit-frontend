...
function AccidentDialogHeader({ incident, timeString }) {
  return (
    <div className="bg-gradient-to-r from-safe-danger to-safe-danger/80 text-white px-[16px] sm:px-[20px] py-[14px] sm:py-[16px] flex items-center gap-[12px] shadow-lg flex-shrink-0">
