    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Delete Camera">
      <div className="space-y-4">
        ...
        <p className="text-gray-300">
          Are you sure you want to delete <span className="font-semibold text-white">{camera.name}</span>?
        </p>
        ...
        <div className="flex justify-end gap-2 mt-6">
          ...
          <button onClick={handleDelete} disabled={submitting} className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 disabled:opacity-50">
