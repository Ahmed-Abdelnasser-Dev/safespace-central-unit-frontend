...
export const PAGE_CONFIG = {
  ...
  '/analytics':            { title: 'Analytics Overview',   section: 'Analytics' },
  '/analytics/incidents':  { title: 'Incident Analysis',    section: 'Analytics' },
  '/analytics/nodes':      { title: 'Node Health',          section: 'Analytics' },
  '/analytics/heatmap':    { title: 'Heatmap',              section: 'Analytics' },
  '/analytics/reports':    { title: 'Reports',              section: 'Analytics' },
};
...
export const ROLE_NAV_CONFIG = {
  admin: {
    ...
    navItems: [
      ...
      { label: 'Analytics Overview', icon: 'chart-pie', path: '/analytics' },
      { label: 'Incident Analysis', icon: 'triangle-exclamation', path: '/analytics/incidents' },
      { label: 'Node Health', icon: 'server', path: '/analytics/nodes' },
      { label: 'Heatmap', icon: 'map', path: '/analytics/heatmap' },
      { label: 'Reports', icon: 'file-lines', path: '/analytics/reports' },
